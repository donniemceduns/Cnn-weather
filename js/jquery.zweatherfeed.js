	...
	$.fn.weatherfeed = function(locations, options, fn) {	
		...
		return this.each(function(i, e) {
			...
			var _process = function(e, feed, options) {
				...
				if (options.link) html += '<div class="weatherLink"><a href="'+ feed.link +'" target="'+ options.linktarget +'" title="Read full forecast"></a></div>';

				html += '</div>';

				// Alternate row classes
				if (row == 'odds') { row = 'evens'; } else { row = 'odds';	}
